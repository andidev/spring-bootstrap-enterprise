...
public class UserDateFormatAnnotationFormatterFactory
        implements AnnotationFormatterFactory<UserDateFormat> {
    ...
    @Override
    public Printer<?> getPrinter(UserDateFormat annotation, Class<?> fieldType) {
    ...
    @Override
    public Parser<DateTime> getParser(UserDateFormat annotation, Class<?> fieldType) {
        return new DateTimeParser(getFormatter(annotation, fieldType));
    }

    protected DateTimeFormatter getFormatter(UserDateFormat annotation, Class<?> fieldType) {
        UserDateFormatterFactory factory = new UserDateFormatterFactory();
        ...
        return factory.createDateFormatter();
    }
