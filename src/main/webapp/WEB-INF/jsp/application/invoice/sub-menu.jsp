...
<c:url var="searchUrl" value="/invoice/search"/>
<c:url var="createUrl" value="/invoice/create"/>
...
<div class="sub-menu" id="sub-menu">
    ...
    <div class="bottom-content">
        ...
        <ul class="reference-menu" id="reference-menu">
            ...
            <li class="menu-item show-invoice"><a href="${priceListUrl}">Price List<span class="arrow ui-icon ui-icon-arrow-1-w" /></a></li>
        </ul>
        <br style="clear:left">
